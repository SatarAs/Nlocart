 ...
 */
final class Version20200927183753 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE artist (id INT AUTO_INCREMENT NOT NULL, artist_last_name VARCHAR(255) NOT NULL, artist_first_name VARCHAR(255) NOT NULL, artist_nickname VARCHAR(255) NOT NULL, artist_email VARCHAR(255) NOT NULL, artist_biography LONGTEXT DEFAULT NULL, artist_phone_home VARCHAR(45) DEFAULT NULL, artist_cell_phone VARCHAR(45) NOT NULL, artist_website VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE artwork (id INT AUTO_INCREMENT NOT NULL, artwork_category_id INT NOT NULL, artist_id INT NOT NULL, artwork_support_id INT NOT NULL, artwork_name VARCHAR(255) NOT NULL, artwork_picture VARCHAR(255) NOT NULL, artwork_creation_date DATE NOT NULL, artwork_height DOUBLE PRECISION DEFAULT NULL, artwork_width DOUBLE PRECISION DEFAULT NULL, artwork_depth DOUBLE PRECISION DEFAULT NULL, artwork_weight DOUBLE PRECISION DEFAULT NULL, artwork_sale_price DOUBLE PRECISION DEFAULT NULL, artwork_rental_price DOUBLE PRECISION DEFAULT NULL, artwork_description LONGTEXT DEFAULT NULL, artwork_availability TINYINT(1) NOT NULL, artwork_special TINYINT(1) NOT NULL, INDEX IDX_881FC5765C5AF308 (artwork_category_id), INDEX IDX_881FC576B7970CF8 (artist_id), INDEX IDX_881FC5761BF80AE7 (artwork_support_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
