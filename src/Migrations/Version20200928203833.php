 ...
 */
final class Version20200928203833 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE artist CHANGE artist_phone_home artist_phone_home VARCHAR(45) DEFAULT NULL, CHANGE artist_website artist_website VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE artwork ADD slug VARCHAR(255) NOT NULL, CHANGE artwork_height artwork_height DOUBLE PRECISION DEFAULT NULL, CHANGE artwork_width artwork_width DOUBLE PRECISION DEFAULT NULL, CHANGE artwork_depth artwork_depth DOUBLE PRECISION DEFAULT NULL, CHANGE artwork_weight artwork_weight DOUBLE PRECISION DEFAULT NULL, CHANGE artwork_sale_price artwork_sale_price DOUBLE PRECISION DEFAULT NULL, CHANGE artwork_rental_price artwork_rental_price DOUBLE PRECISION DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE artist CHANGE artist_phone_home artist_phone_home VARCHAR(45) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE artist_website artist_website VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE artwork DROP slug, CHANGE artwork_height artwork_height DOUBLE PRECISION DEFAULT \'NULL\', CHANGE artwork_width artwork_width DOUBLE PRECISION DEFAULT \'NULL\', CHANGE artwork_depth artwork_depth DOUBLE PRECISION DEFAULT \'NULL\', CHANGE artwork_weight artwork_weight DOUBLE PRECISION DEFAULT \'NULL\', CHANGE artwork_sale_price artwork_sale_price DOUBLE PRECISION DEFAULT \'NULL\', CHANGE artwork_rental_price artwork_rental_price DOUBLE PRECISION DEFAULT \'NULL\'');
